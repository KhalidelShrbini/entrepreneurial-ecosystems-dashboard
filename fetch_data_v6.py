...
INDICATORS = {
    ...
    "IC.REG.DURS": "days_to_start_business",         # Time required to start a business, days (business friction)
}
...
SPARSE_INDICATORS = {"IT.NET.USER.ZS", "IC.REG.DURS", "SL.EMP.SELF.ZS", "SI.POV.DDAY"}
...
def main():
    ...
    print("\nDone. Next: python build_database_v3.py")
